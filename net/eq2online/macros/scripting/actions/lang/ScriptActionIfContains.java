...
/*    */       
/* 20 */       String haystack = provider.expand(macro, params[0], false).toLowerCase();
/* 21 */       String needle = provider.expand(macro, params[1], false).toLowerCase();
/*    */       
/* 23 */       return haystack.contains(needle);
/*    */     } 
/*    */     
/* 26 */     return false;
/*    */   }
