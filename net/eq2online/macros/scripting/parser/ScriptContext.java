...
/*     */ {
/*  28 */   private static final Map<String, ScriptContext> contexts = new HashMap<>();
/*     */   
...
/* 201 */     if (this.core != null)
/*     */     {
/* 203 */       this.core.setLanguage(language);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 221 */     return (this == obj || this.name.equals(obj));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 241 */     if (!contexts.containsKey(name))
/*     */     {
/* 243 */       return new ScriptContext(name);
/*     */     }
/*     */     
/* 246 */     return contexts.get(name);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Collection<ScriptContext> getAvailableContexts() {
/* 251 */     return Collections.unmodifiableCollection(contexts.values());
/*     */   }
/*     */ }
