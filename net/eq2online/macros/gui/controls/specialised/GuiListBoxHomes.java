...
/*     */ {
/*     */   public GuiListBoxHomes(Macros macros, bib minecraft, int controlId) {
/*  28 */     super(macros, minecraft, controlId, true, macros.getFile(".homes.txt"), true);
/*     */     
/*  30 */     this.iconTexture = ResourceLocations.DYNAMIC_HOMES;
...
/*  37 */     return MacroParam.Type.HOME.getKey();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  53 */     if ((this.macros.getSettings()).configsForHomes) {
/*     */       
...
/*     */     
/*  68 */     ListEntry<String> newHome = new ListEntry(-1, I18n.get("list.new.home"), "");
/*     */     
...
/*     */     {
/*  72 */       ((List<ListEntry<String>>)config.getValue()).add(newHome);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     newConfig.add(new ListEntry(-1, I18n.get("list.new.home"), ""));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  92 */     return createObject(text, iconId, ResourceLocations.DYNAMIC_HOMES);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
