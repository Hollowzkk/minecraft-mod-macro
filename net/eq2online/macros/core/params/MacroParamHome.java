...
/*     */ {
/*     */   public MacroParamHome(Macros macros, bib mc, MacroParam.Type type, IMacroParamTarget target, MacroParams params, MacroParamProvider<String> provider) {
...
/*  53 */     return MacroParam.getLocalisedString("param.prompt.home", new String[] { this.target.getDisplayName() });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */     return (this.replaceFirstOccurrenceOnly || this.settings.getCompilerFlagHome());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     gui.displayText = I18n.get(editing ? "entry.editgome" : "entry.newhome");
...
/* 119 */     return ResourceLocations.DYNAMIC_HOMES;
/*     */   }
/*     */ }
