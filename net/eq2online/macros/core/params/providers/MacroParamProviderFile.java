...
/*    */ {
/* 19 */   private static final Pattern PATTERN = Pattern.compile("(?<![\\x5C])\\x24\\x24m", 2);
/*    */ 
/*    */   
/*    */   public MacroParamProviderFile(Macros macros, bib mc, MacroParam.Type type) {
...
/* 35 */     return (MacroParam<String>)new MacroParamFile(this.macros, this.mc, getType(), target, params, this);
/*    */   }
/*    */ }
